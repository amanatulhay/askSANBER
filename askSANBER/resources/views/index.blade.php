    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url({{ URL::asset('template2/img/intro-carousel/1.jpg') }});">
          ...
          <div class="carousel-item" style="background-image: url({{ URL::asset('template2/img/intro-carousel/3.jpg') }});">
            <div class="carousel-container">
              <div class="carousel-content">
